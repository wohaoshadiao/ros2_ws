...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/robocar_test_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robocar_test_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robocar_test_cpp/environment/path.sh"
